...
#define readw_relaxed_no_log(c) ({ u16 __r = le16_to_cpu((__force __le16) \
					__raw_readw_no_log(c)); __r; })
...
#ifdef CONFIG_LGE_MTK_RTB
#define writeb_relaxed_no_log(v, c) __raw_writeb_no_log(v,c)
