...
/* ////////////////////////////////////////////////////////////// */
long ZC524AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
    long i4RetValue = 0;
...
void ZC524AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
        int *pAF_Opened)
{
