...
extern void DW9714VAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
                                 int *pAF_Opened);
...
#ifdef CONFIG_MTK_LENS_ZC524AFWT_SUPPORT
#define ZC524AFWT_SetI2Cclient ZC524AFWT_SetI2Cclient_Main
#define ZC524AFWT_Ioctl ZC524AFWT_Ioctl_Main
#define ZC524AFWT_Release ZC524AFWT_Release_Main
extern void ZC524AFWT_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
                                 int *pAF_Opened);
extern long ZC524AFWT_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
                          unsigned long a_u4Param);
extern int ZC524AFWT_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
