...
#define HI556_LSC_DATA_LENGTH 884

struct hi556_info_struct {
	kal_uint8 info_flag;
	kal_uint8 vendor_id;
	...
	kal_uint8 month;
	kal_uint8 day;
	kal_uint8 wb_lsc_stationNum;
	kal_uint8 pdaf_stationNum;
	kal_uint8 af_stationNum;
	kal_uint8 vcm_vendorId;
	kal_uint8 vcm_moduleId;
	kal_uint8 info_checksum_l;
	kal_uint8 info_checksum_h;
};

struct hi556_wb5100k {
	kal_uint8 wb_flag;
	kal_uint8 RGr_ratio_l;
	kal_uint8 RGr_ratio_h;
	kal_uint8 BGr_ratio_l;
	kal_uint8 BGr_ratio_h;
	kal_uint8 GbGr_ratio_l;
	kal_uint8 GbGr_ratio_h;
	kal_uint8 wb_checksum_l;
	kal_uint8 wb_checksum_h;
};

struct hi556_wb3000k {
	kal_uint8 wb_flag;
	kal_uint8 RGr_ratio_l;
	kal_uint8 RGr_ratio_h;
	kal_uint8 BGr_ratio_l;
...
struct hi556_lsc_struct {
	kal_uint8 lsc_flag;
	kal_uint8 lsc_data[HI556_LSC_DATA_LENGTH];
	kal_uint8 lsc_checksum_l;
	kal_uint8 lsc_checksum_h;
};

struct hi556_af_struct {
	kal_uint8 af_flag;
	kal_uint8 af_inf_l;
	kal_uint8 af_inf_h;
	kal_uint8 af_macro_l;
	kal_uint8 af_macro_h;
	kal_uint8 af_checksum_l;
	kal_uint8 af_checksum_h;
};

struct hi556_otp_struct {
	kal_uint8 isLoaded;  /*LGE_CHANGE, 2017-05-15, otp reading only one time, soojong.jin@lge.com*/
	struct hi556_info_struct	infoStr;
	struct hi556_wb5100k		wb5100k;
	struct hi556_wb3000k		wb3000k;
	struct hi556_lsc_struct		lscStr;
	struct hi556_af_struct		afStr;
};
