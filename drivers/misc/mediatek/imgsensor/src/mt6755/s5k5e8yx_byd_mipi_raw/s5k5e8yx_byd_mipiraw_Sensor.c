...
#include "s5k5e8yx_byd_mipiraw_Sensor.h"

/****************************Modify following Strings for debug****************************/
#define PFX "s5k5e8yx_byd_camera_sensor"
#define LOG_1 LOG_INF("s5k5e8yx_byd,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = S5K5E8YX_BYD_SENSOR_ID - 0x1,
	...
	.i2c_addr_table = {0x5a, 0xff},//20,5a
};
	...
	while(imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
            ...
            strcpy(front_sensor_name, "s5k5e8_byd");
...
UINT32 S5K5E8YX_BYD_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	S5K5E8YX_BYD_MIPI_RAW_SensorInit	*/
