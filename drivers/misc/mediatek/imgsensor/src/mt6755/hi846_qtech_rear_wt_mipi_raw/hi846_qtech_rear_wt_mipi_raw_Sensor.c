...
#include "hi846_qtech_rear_wt_mipi_raw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = (HI846_QTECH_REAR_WT_SENSOR_ID - 0x2),
	...
	.i2c_addr_table = {0x40, 0xff},//{0x40, 0x40, 0x40, 0xff},
};



static imgsensor_struct imgsensor = {
	.mirror = IMAGE_NORMAL,				//mirrorflip information //zhaozhensen@wind-mobi.com 20161017
...
#if 1
static kal_uint16 read_hi846_moduleid(kal_uint32 addr)
{
...
write_cmos_sensor(0x0074, 0x09B6);///add
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id =return_sensor_id();
			...
			hi846_module_id = read_hi846_moduleid(0x0001);
			if(0x0B != hi846_module_id)
			{
				LOG_INF("hi846_module_id: 0x%x\n", hi846_module_id);
				//*sensor_id = 0xFFFFFFFF;
				//return ERROR_SENSOR_CONNECT_FAIL;
				printk("[HI846_QTech] vendor id is different!! you should check the EEPROM or Module hardware\n");
			}
		...
		case SENSOR_FEATURE_GET_SENSOR_VIEWANGLE:
			{
				...
				*pHorFOV = (0x3D)<<16 | (0x3D); // 16:9 = 61, 4:3 = 61 // (61)<<16 | (61)   //61 degree
...
UINT32 HI846_QTECH_REAR_WT_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
