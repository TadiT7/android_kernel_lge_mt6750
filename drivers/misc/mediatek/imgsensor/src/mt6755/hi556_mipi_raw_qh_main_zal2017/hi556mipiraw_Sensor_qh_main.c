...
#include "hi556mipiraw_Sensor_qh_main.h"
...
#define LOG_1 LOG_INF("hi556_qh_main,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = HI556_SENSOR_ID_QH_MAIN,//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
	/* HI556_SENSOR_ID_QH_MAIN is configed as 0x558 in kd_imgsensor.h */
