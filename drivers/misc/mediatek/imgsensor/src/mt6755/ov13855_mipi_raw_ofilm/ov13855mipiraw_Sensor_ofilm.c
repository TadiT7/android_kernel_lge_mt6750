...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13855_SENSOR_ID_OFILM,
...
#if 1
static kal_uint16 read_ov13855_ofilm_moduleid(kal_uint32 addr)
{
...
{
	LOG_INF("capture_setting RES_4224x3136_30fps currefps = %d\n", currefps);
	write_cmos_sensor(0x0100,0x00);
...
{
	LOG_INF("normal_video_setting RES_4224x3136_30fps\n");
	write_cmos_sensor(0x0100,0x00);
	mdelay(5);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    kal_uint8 i = 0;
    kal_uint8 retry = 2;
	kal_uint16 ov13855_ofilm_module_id = 0;
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
				ov13855_ofilm_module_id = read_ov13855_ofilm_moduleid(0x0001);
				if(0x07 != ov13855_ofilm_module_id)
				{
					printk("ov13855_ofilm_module_id: 0x%x\n", ov13855_ofilm_module_id);
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				}
                printk("i2c write id: 0x%x, sensor id: 0x%x,module_id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id,ov13855_ofilm_module_id);
                return ERROR_NONE;
            }
...
UINT32 OV13855_MIPI_RAW_OFILM_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
