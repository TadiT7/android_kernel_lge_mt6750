...
#include "hi846_byd_mipi_raw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI846_BYD_SENSOR_ID - 0x1000,
...
// [LGE_UPDATE_S] [kyunghun.oh@lge.com] [2017-09-18] Creation of node for camera module identification.
static int hi846_byd_read_eepromVendorID(void)
{
    int retry = 3;
    ...
    printk("[hi846_byd_read_eepromVendorID] read eeprom id = %d\n", vendorID_readFrom_rear_imageSensor);
    if(vendorID_readFrom_rear_imageSensor != 0x42)
    {
        printk("[hi846_byd_read_eepromVendorID] matching fail!! It should be 0x01 but read %d\n", vendorID_readFrom_rear_imageSensor);
        return -1;
    }
    else
    {
        printk("[hi846_byd_read_eepromVendorID] matching OK\n");
        strcpy(rear_sensor_name, "sl846_byd");
        return 0;
    }
}
// [LGE_UPDATE_E] [kyunghun.oh@lge.com] [2017-09-18] Creation of node for camera module identification.
...
// [LGE_UPDATE_S] [kyunghun.oh@lge.com] [2017-09-18] Creation of node for camera module identification.
                    if(hi846_byd_read_eepromVendorID() != 0)
...
UINT32 HI846_BYD_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
