...
#include "hi556mipiraw_Sensor_qt_sub.h"
...
#define LOG_1 LOG_INF("hi556_qt_sub,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = HI556_SENSOR_ID_QT_SUB,//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
	/* HI556_SENSOR_ID_QT_SUB is configed as 0x557 in kd_imgsensor.h */
