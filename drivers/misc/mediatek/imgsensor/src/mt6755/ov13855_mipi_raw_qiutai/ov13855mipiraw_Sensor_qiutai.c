...
#define PFX "OV13855_qiutai_camera_sensor"
#define LOG_INF(fmt, args...)   pr_debug(PFX "[%s] " fmt, __FUNCTION__, ##args)

extern bool read_ov13855_qiutai_eeprom( kal_uint16 addr, BYTE* data, kal_uint32 size);
extern void kdSetI2CSpeed(u16 i2cSpeed);

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13855_SENSOR_ID_QIUTAI,
...
#if 1
static kal_uint16 read_ov13855_qiutai_moduleid(kal_uint32 addr)
{
...
static void sensor_init(void)
{
    ...
    write_cmos_sensor(0x59f4, 0x32); //20170524 close auto lenc
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    kal_uint8 i = 0;
    kal_uint8 retry = 2;
	kal_uint16 ov13855_qiutai_module_id = 0;
        ...
        do {
            *sensor_id = return_sensor_id()+1;
            if (*sensor_id == imgsensor_info.sensor_id) {
				ov13855_qiutai_module_id = read_ov13855_qiutai_moduleid(0x0001);
				if(0x0b != ov13855_qiutai_module_id)
				{
					printk("ov13855_qiutai_module_id: 0x%x\n", ov13855_qiutai_module_id);
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				}
                printk("i2c write id: 0x%x, sensor id: 0x%x,module_id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id,ov13855_qiutai_module_id);
                return ERROR_NONE;
            }
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:
			...
			read_ov13855_qiutai_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;
		...
		case SENSOR_FEATURE_GET_SENSOR_VIEWANGLE:
			{
				...
				*pHorFOV = (0x46)<<16 | (0x46); // 16:9 = 70, 4:3 = 70 // (70)<<16 | (70)   //70 degree
...
UINT32 OV13855_MIPI_RAW_QIUTAI_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
