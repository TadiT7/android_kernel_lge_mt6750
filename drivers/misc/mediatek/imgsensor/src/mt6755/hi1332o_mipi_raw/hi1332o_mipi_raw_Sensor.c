...
#include "hi1332o_mipi_raw_Sensor.h"

#define PFX "HI1332O_camera_sensor"

#define LOG_INF(format, args...)	pr_debug(PFX "[%s] " format, __func__, ##args)

/*#define HI1332O_BURST_ENABLE		0*/
/*#define HI1332O_OTP*/
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = (HI1332O_SENSOR_ID - 0x10000),
	...
	.i2c_addr_table = {0x40, 0xff}, //{0x44, 0x40, 0xff},
	.i2c_speed = 400,
};
...
#ifdef HI1332O_OTP
kal_uint16 read_Hi1332ootp_8(kal_uint32 addr)
{
	kdSetI2CSpeed(imgsensor_info.i2c_speed);
	kal_uint16 get_byte = 0;
...
void hi1332o_init_setting_normal(void)
{
...
void hi1332o_preview_setting_normal(void)
{
	write_cmos_sensor(0x0a00, 0x0000);	/*Sleep on */
...
static void hi1332o_capture_setting_normal(kal_uint16 currefps)
{
	write_cmos_sensor(0x0a00, 0x0000);	/*sleep on */
	write_cmos_sensor(0x404c, 0xf808);
	write_cmos_sensor(0x000a, 0x0000);
	...
	if (currefps == 150) {
		LOG_INF("capture 15fps : frame_length = %x, line_length = %x\n",
...
/*write_cmos_sensor(0x0008, imgsensor.line_length);*/
		...
		LOG_INF("capture not 15fps : frame_length = %x, line_length = %x\n",
			imgsensor.frame_length, imgsensor.line_length);
...
void hi1332o_hs_video_setting_normal(void)
{
	write_cmos_sensor(0x0a00, 0x0000);	/*sleep on */
...
void hi1332o_slim_video_setting_normal(void)
{
	write_cmos_sensor(0x0a00, 0x0000);	/*sleep on */
...
unsigned short hi1332o_init_setting[] = {
...
unsigned short hi1332o_preview_setting[] = {
...
unsigned short hi1332o_capture_setting[] = {
...
unsigned short hi1332o_hs_video_setting[] = {
...
unsigned short hi1332o_slim_video_setting[] = {
		...
		do {
			*sensor_id = ((read_cmos_sensor(0x0F17) << 8) | read_cmos_sensor(0x0F16));
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				LOG_INF("get_imgsensor_id -> call read_Hi1332O_otp_mtk_fmt func\n");

				read_Hi1332O_otp_mtk_fmt(void) ();
#endif
				return ERROR_NONE;
			}
...
#ifdef HI1332O_OTP
				LOG_INF("open -> call read_Hi1332O_otp_mtk_fmt func\n");
				read_Hi1332O_otp_mtk_fmt();
#endif
				break;
			}
...
#ifdef HI1332O_BURST_ENABLE
	Hynix_i2c_burst(hi1332o_init_setting, sizeof(hi1332o_init_setting) / 2);
#else
	hi1332o_init_setting_normal();
#endif
...
#ifdef HI1332O_BURST_ENABLE
	Hynix_i2c_burst(hi1332o_preview_setting, sizeof(hi1332o_preview_setting) / 2);
#else
	hi1332o_preview_setting_normal();
#endif
...
static void capture_setting(kal_uint16 currefps)
{
	...
	Hynix_i2c_burst(hi1332o_capture_setting, sizeof(hi1332o_capture_setting) / 2);
#else
	LOG_INF("burst disable\n");
	hi1332o_capture_setting_normal(currefps);
#endif
}
			       ...
			       MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	Hynix_i2c_burst(hi1332o_capture_setting, sizeof(hi1332o_capture_setting) / 2);
#else
	hi1332o_capture_setting_normal(imgsensor.current_fps);
#endif
	set_mirror_flip(imgsensor.mirror);
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	Hynix_i2c_burst(hi1332o_hs_video_setting, sizeof(hi1332o_hs_video_setting) / 2);
#else
	hi1332o_hs_video_setting_normal();
#endif
	set_mirror_flip(imgsensor.mirror);
...
#ifdef HI1332O_BURST_ENABLE
	Hynix_i2c_burst(hi1332o_slim_video_setting, sizeof(hi1332o_slim_video_setting) / 2);
#else
	hi1332o_slim_video_setting_normal();
#endif
	set_mirror_flip(imgsensor.mirror);
...
#ifdef HI1332O_BURST_ENABLE	/*add new code */
