...
//[LGE_UPDATE_S][bk.bae@lge.com][2018-01-18] Conditional statements for EEPROM devices using different i2c.
...
//[LGE_UPDATE_E][bk.bae@lge.com][2018-01-18] Conditional statements for EEPROM devices using different i2c.
