...
PowerUp PowerOnList = {
	{
	{SENSOR_DRVNAME_OV13855_MIPI_RAW_OFILM,
	  {
	   {DOVDD, Vol_1800, 0},
	   {AVDD, Vol_2800, 0},
	   {DVDD, Vol_1200, 2},
	...
	{SENSOR_DRVNAME_OV13855_MIPI_RAW_QIUTAI,
	 {
	  {DOVDD, Vol_1800, 0},
	  {AVDD, Vol_2800, 0},
	  {DVDD, Vol_1200, 2},
	...
	{SENSOR_DRVNAME_HI846_QTECH_REAR_WT_MIPI_RAW,
	  {
	   {DOVDD, Vol_1800, 0},
	   {AVDD, Vol_2800, 0},
	   {DVDD, Vol_1200, 2},
	...
	{SENSOR_DRVNAME_HI846_DMEGC_FRONT_WT_MIPI_RAW,
	  {
	   {DOVDD, Vol_1800, 0},
	   {AVDD, Vol_2800, 0},
	   {DVDD, Vol_1200, 2},
	...
	{SENSOR_DRVNAME_HI846_BYD_FRONT_WT_MIPI_RAW,
	  {
	   {DOVDD, Vol_1800, 0},
	   {AVDD, Vol_2800, 0},
	   {DVDD, Vol_1200, 2},
	...
	{SENSOR_DRVNAME_HI556_MIPI_RAW_LGW5M,
	  {
	   {DOVDD, Vol_1800, 0},
	   {AVDD, Vol_2800, 0},
	   {DVDD, Vol_1200, 2},
	...
	{SENSOR_DRVNAME_HI556_BROD_FRONT_WT_MIPI_RAW,
	  {
	   {DOVDD, Vol_1800, 0},
	   {AVDD, Vol_2800, 0},
	   {DVDD, Vol_1200, 2},
...
#if 0
	{SENSOR_DRVNAME_GC5025AW_MIPI_RAW,
	  {
	   {PDN, Vol_Low, 1},
	   {RST, Vol_Low, 1},
	   {DOVDD, Vol_1800, 1},
			...
			if (currSensorName && (PowerOnList.PowerSeq[pwListIdx].SensorName != NULL)
				...
				for (pwIdx = 0; pwIdx < 10; pwIdx++) {
					if (PowerOnList.PowerSeq[pwListIdx].PowerInfo[pwIdx].
						...
						// bug 316750  yewei add in 20171106
