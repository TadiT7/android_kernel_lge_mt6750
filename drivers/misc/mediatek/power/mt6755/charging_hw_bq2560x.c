...
const unsigned int CS_VTH[] = {
	...
	246000, 252000,	258000, 264000, 270000,
	276000, 282000, 288000,	294000, 300000,
};
#if 0
...
#endif
/* Add for bq25601 by zhangdong@huaqin.com */
const unsigned int INPUT_CS_VTH[] = {
	...
	CHARGE_CURRENT_2900_00_MA,	CHARGE_CURRENT_3000_00_MA,	CHARGE_CURRENT_3100_00_MA,	CHARGE_CURRENT_3200_00_MA,
	CHARGE_CURRENT_MAX
};
...
static unsigned int charging_hw_init(void *data)
{
	...
	bq2560x_set_batlowv(0x0);	/* BATLOWV 3.0V 0x01 -> 0x0 by zhangdong5@huaqin.com*/
...
static unsigned int charging_set_input_current(void *data)
{
	...
	battery_log(BAT_LOG_CRTI, "charging_set_cc_input_current set_cc_input_current=%d\n",
		    *(unsigned int *) data);
...
static unsigned int charging_set_ta_current_pattern(void *data)
{
	...
	if (KAL_FALSE == charging_status) {
		...
		/* 0x0(bq24196) -> 0x9(bq25601) by zhangdong5@huaqin.com */
		bq2560x_set_ichg(0x9);	/* Set charging current 500ma */
	...
	if (increase == KAL_TRUE) {
		...
		/* 0x02(bq24196) -> 0x04(bq25601) by zhangdong5@huaqin.com */
		bq2560x_set_iinlim(0x4);	/* 500mA */
...
{
	signed int status;
	//zhangdong5@huaqin.com modified for bq25601 has only implemented 32 interfaces
	if (cmd < CHARGING_CMD_SET_TA20_RESET)//CHARGING_CMD_NUMBER)
