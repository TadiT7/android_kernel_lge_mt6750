...
#ifdef CONFIG_MTK_BQ25601_SUPPORT
extern void bq2560x_set_otg_config(unsigned int);
extern void bq2560x_set_boost_lim(unsigned int);
#endif
...
#elif defined(CONFIG_MTK_BQ25601_SUPPORT)
	mtk_xhci_mtk_printk(K_DEBUG, "loyalty otg enable.\n");
	bq2560x_set_otg_config(0x01);
	bq2560x_set_boost_lim(0x01);
#else
...
static void mtk_disable_otg_mode(void)
{
	...
	bq25898_otg_en(0x0);
#elif defined(CONFIG_MTK_BQ25601_SUPPORT)
	mtk_xhci_mtk_printk(K_DEBUG, "loyalty otg disable.\n");
	bq2560x_set_otg_config(0x0);
#else
#ifdef CONFIG_INPUT_EPACK
