...
//FIXME: fixed build error temporary 
//#ifdef CONFIG_LGE_SENSOR
/*-------------------LGE add-------------------------------------------*/
#define GSENSOR_IOCTL_SET_ENABLE               _IOW(GSENSOR, 0x80, int)
...
//#ifdef CONFIG_LGE_SENSOR
/*-------------------LGE add-------------------------------------------*/
#define COMPAT_GSENSOR_IOCTL_SET_ENABLE               _IOW(GSENSOR, 0x80, compat_int_t)
//#endif // CONFIG_LGE_SENSOR
#endif
...
//#ifdef CONFIG_LGE_SENSOR
/*-------------------LGE add-------------------------------------------*/
#define COMPAT_ALSPS_GET_DEVICEID			_IOR(ALSPS, 0x80, compat_int_t)
#define COMPAT_ALSPS_GET_CALI				COMPAT_ALSPS_IOCTL_GET_CALI
#define COMPAT_ALSPS_SET_CALI				COMPAT_ALSPS_IOCTL_SET_CALI
//#endif // CONFIG_LGE_SENSOR
#endif
...
#define GYROSCOPE_IOCTL_GET_GYFLAG            _IOR(GYROSCOPE, 0x11, int)
#define GYROSCOPE_IOCTL_GET_RVFLAG            _IOR(GYROSCOPE, 0x12, int)
#define GYROSCOPE_IOCTL_GET_OPEN_STATUS       _IOR(GYROSCOPE, 0x13, int)
#define GYROSCOPE_IOCTL_SET_RVDATA            _IOR(GYROSCOPE, 0x14, int)
...
#define COMPAT_GYROSCOPE_IOCTL_GET_GYFLAG            _IOR(GYROSCOPE, 0x11, compat_int_t)
#define COMPAT_GYROSCOPE_IOCTL_GET_RVFLAG            _IOR(GYROSCOPE, 0x12, compat_int_t)
#define COMPAT_GYROSCOPE_IOCTL_GET_OPEN_STATUS       _IOR(GYROSCOPE, 0x13, compat_int_t)
#define COMPAT_GYROSCOPE_IOCTL_SET_RVDATA            _IOR(GYROSCOPE, 0x14, compat_int_t)
#endif
