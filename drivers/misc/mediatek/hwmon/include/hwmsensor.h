...
// needed for hal
#ifdef BOSCH_BST_SENSOR
#define SENSOR_TYPE_UNCALI_GYROSCOPE    27
#define SENSOR_TYPE_UNCALI_MAG          28
...
#endif // BOSCH_BST_SENSOR

// needed for hal
#ifdef CONFIG_LGE_SENSOR_SLOPE_DETECTOR
#define SENSOR_TYPE_SLOPE_DETECTOR          (29)
#define SENSOR_STRING_TYPE_SLOPE_DETECTOR            "android.sensor.slope_detector"
...
// needed for hal
#ifdef BOSCH_BST_SENSOR
#define ID_UNCALI_GYRO                  (ID_BASE+SENSOR_TYPE_UNCALI_GYROSCOPE-1)
#define ID_UNCALI_MAG                   (ID_BASE+SENSOR_TYPE_UNCALI_MAG-1)
#endif // BOSCH_BST_SENSOR
...
#define LGE_SENSOR_TYPE_BASE              499898100 // need to sync with LGSensor.java
#ifdef CONFIG_LGE_SENSOR_SLOPE_DETECTOR
#define BSTEXT_SENSOR_TYPE_SLOPE_DETECTOR (LGE_SENSOR_TYPE_BASE + 6) // slope detector type
#endif // CONFIG_LGE_SENSOR_SLOPE_DETECTOR
