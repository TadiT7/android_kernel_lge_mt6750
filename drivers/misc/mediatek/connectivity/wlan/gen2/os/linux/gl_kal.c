...
#if defined ( CFG_TC1_FEATURE ) && defined (PPR2_TEST)
	static BOOLEAN firstPing = FALSE;
	static BOOLEAN secondPing = FALSE;
#endif
...
#if defined ( CFG_TC1_FEATURE ) && defined (PPR2_TEST)
// for 5.16 test case
				if (firstPing == TRUE && ucUserPriority == 0) {
					secondPing = TRUE;    /* use VI priority */
				}
#endif
