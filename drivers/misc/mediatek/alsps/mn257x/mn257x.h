#ifndef __ELAN_MN257x__
#define __ELAN_MN257x__

#define ELAN_IOCTL_MAGIC 'c'
#define ELAN_MN8800_IOCTL_GET_PFLAG _IOR(ELAN_IOCTL_MAGIC, 1, int *)
#define ELAN_MN8800_IOCTL_GET_LFLAG _IOR(ELAN_IOCTL_MAGIC, 2, int *)
#define ELAN_MN8800_IOCTL_ENABLE_PFLAG _IOW(ELAN_IOCTL_MAGIC, 3, int *)
#define ELAN_MN8800_IOCTL_ENABLE_LFLAG _IOW(ELAN_IOCTL_MAGIC, 4, int *)
#define ELAN_MN8800_IOCTL_GETDATA _IOR(ELAN_IOCTL_MAGIC, 5, int *)
...
#define MN_PS_INTT_272			(8<<2)
#define MN_PS_INTT_384			(9<<2)
#define MN_PS_INTT_520			(10<<2)
#define MN_PS_INTT_784			(11<<2)
#define MN_PS_INTT_1040		(12<<2)
#define MN_PS_INTT_2064		(13<<2)
#define MN_PS_INTT_4112		(14<<2)
#define MN_PS_INTT_6160		(15<<2)
...
#define MN_PSALS_ADC_11	(0x00 << 3)
#define MN_PSALS_ADC_12	(0x01 << 3)
#define MN_PSALS_ADC_13	(0x02 << 3)
#define MN_PSALS_ADC_14	(0x03 << 3)
...
#define MN_ALS_PRE          (0 << 5)
#define MN_ALS_STD          (1 << 5)

#define MN_IR_ON_CTRL_OFF	(0x00 << 5)
#define MN_IR_ON_CTRL_ON	(0x01 << 5)

#define MN_IR_MODE_CURRENT	(0x00 << 4)
#define MN_IR_MODE_VOLTAGE	(0x01 << 4)

#define MN_IR_DRIVE_200	(0x00)
#define MN_IR_DRIVE_100	(0x01)
#define MN_IR_DRIVE_50		(0x02)
#define MN_IR_DRIVE_10		(0x03)


#define MN_INT_CTRL_ALS_OR_PS		(0x00 << 4)
#define MN_INT_CTRL_ALS			(0x01 << 4)
#define MN_INT_CTRL_PS				(0x02 << 4)
...
#define MN_RESETN_RESET	(0x00 << 1)
#define MN_RESETN_RUN		(0x01 << 1)

#define MN_POWER_OFF		(0x01)
#define MN_POWER_ON		(0x00)

#define MN_ALS_INT_CHSEL_0	(0x00 << 4)
#define MN_ALS_INT_CHSEL_1	(0x01 << 4)

#define MN_SATURATION				(0x01 << 5)
#define MN_SATURATION_NOT		    (0x00 << 5)

#define MN_CMP_H_TRIGGER		(0x01 << 4)
#define MN_CMP_H_CLEAR		    (0x00 << 4)

#define MN_CMP_L_TRIGGER		(0x01 << 3)
#define MN_CMP_L_CLEAR		    (0x00 << 3)
...
#define MN_OSC_SEL_1MHZ	(0x07)

#define MN_REVNO           (0x81)

#define MN_A_D             (0x7 << 4)

#define MN_NORMAL      (0 << 3)
#define MN_BYBASS      (1 << 3)

#define MN_GFIN_DISABLE      (0 << 2)
#define MN_GFIN_ENABLE       (1 << 2)

#define MN_VOS_DISABLE      (0 << 1)
#define MN_VOS_ENABLE       (1 << 1)
...
#define    DEVREG_REV_ID       0x20 //REG0x20
    //REG0x21 not defined in spec
#define    DEVREG_CHIP_ID      0x21 //REG0x21
