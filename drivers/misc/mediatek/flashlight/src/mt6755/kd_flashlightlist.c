...
static struct class *flashlight_class = NULL; // LGE_UPDATE, remove warning, youmi.jun@lge.com, 2017/07/05
...
#define FLASHLIGHT_MAJOR 242
	...
	if (flashlight_class == NULL) { // LGE_UPDATE, remove warning, youmi.jun@lge.com, 2017/07/05
	...
	}  // LGE_UPDATE, remove warning, youmi.jun@lge.com, 2017/07/05
...
static int flashlight_remove(struct platform_device *dev)
{
	...
	flashlight_class = NULL; // LGE_UPDATE, remove warning, youmi.jun@lge.com, 2017/07/05
	} // LGE_UPDATE, remove warning, youmi.jun@lge.com, 2017/07/05
