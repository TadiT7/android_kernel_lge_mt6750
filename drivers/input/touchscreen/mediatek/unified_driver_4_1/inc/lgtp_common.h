...
#define TOUCH_FUNC(f)			pr_err(LGTP_TAG"[F]"LGTP_MODULE" %s()\n", __func__)
#define TOUCH_FUNC_EXT(fmt, args...)	pr_err(LGTP_TAG"[F]"LGTP_MODULE" %s() : "fmt, __func__, ##args)
#else
#define TOUCH_ERR(fmt, args...)		pr_err(LGTP_TAG"[E]"LGTP_MODULE" %s() line=%d : "fmt, __func__, \
							__LINE__, ##args)
#define TOUCH_WARN(fmt, args...)	pr_warn(LGTP_TAG"[W]"LGTP_MODULE" %s() line=%d : "fmt, __func__, \
							__LINE__, ##args)
#define TOUCH_LOG(fmt, args...)		pr_info(LGTP_TAG"[L]"LGTP_MODULE" " fmt, ##args)
#define TOUCH_DBG(fmt, args...)		pr_debug(LGTP_TAG"[D]"LGTP_MODULE" " fmt, ##args)
#define TOUCH_FUNC(f)			pr_info(LGTP_TAG"[F]"LGTP_MODULE" %s()\n", __func__)
#define TOUCH_FUNC_EXT(fmt, args...)	pr_info(LGTP_TAG"[F]"LGTP_MODULE" %s() : "fmt, __func__, ##args)
#endif
