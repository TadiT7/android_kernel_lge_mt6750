...
#if defined(CONFIG_LGD_INCELL_LG4894_HD_K6PNA)
#define GPIO_TOUCH_RESET			GPIO10
#define GPIO_TOUCH_RESET_M_GPIO		GPIO_MODE_00
#define GPIO_TOUCH_INT				GPIO1
#define GPIO_TOUCH_INT_M_EINT		GPIO_MODE_00
#endif

#if defined(CONFIG_LGE_TOUCH_SYNAPTICS_TD4100)
#define GPIO_TOUCH_RESET				GPIO10
#define GPIO_TOUCH_RESET_M_GPIO		GPIO_MODE_00
#define GPIO_TOUCH_INT				GPIO1
#define GPIO_TOUCH_INT_M_EINT			GPIO_MODE_00
...
#if defined(CONFIG_LGE_TOUCH_CORE_MTK)
#if defined(CONFIG_LGE_TOUCH_SYNAPTICS_TD4100) || defined(CONFIG_LGD_INCELL_LG4894_HD_K6PNA)
