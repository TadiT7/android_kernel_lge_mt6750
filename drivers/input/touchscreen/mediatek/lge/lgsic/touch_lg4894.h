...
{
	return (struct lg4894_data *)container_of(kobj, struct lg4894_data, kobj);
}
...
static inline int lg4894_read_value(struct device *dev, u16 addr, u32 *value)
{
	return lg4894_reg_read(dev, addr, value, sizeof(*value));
}

static inline int lg4894_write_value(struct device *dev, u16 addr, u32 value)
{
