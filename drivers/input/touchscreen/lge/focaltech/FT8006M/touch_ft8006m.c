...
enum lcm_id { /* Temp value */
	CV1_TCL_FT8006M = 0,
	CV1_LGD_LG4894A = 1,
	CV1_TIANMA_FT8006M = 2,
};
static enum lcm_id lcm_id_status;
...
static bool ft8006m_get_device_type(void)
{
	...
	lcm_id_status = lge_get_maker_id();

	TOUCH_I("%s [lcm_id] = [%d]\n", __func__, lcm_id_status);

	switch(lcm_id_status) {
	case CV1_TCL_FT8006M:
	case CV1_TIANMA_FT8006M:
		ft8006m_panel_type = lcm_id_status;
		bdevice = true;
		break;
	default:
		break;
