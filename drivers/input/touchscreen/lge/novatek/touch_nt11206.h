...
#define RAWDATA_FILE_PATH "/data/logger/touch_rawdata.txt"
#define DELTA_FILE_PATH "/data/logger/touch_delta.txt"
#define BASELINE_FILE_PATH "/data/logger/touch_baseline.txt"
