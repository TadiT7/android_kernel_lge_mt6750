...
static void set_debug_reason(struct device *dev, int type)
{
	...
	lg4946_reg_write(dev, TCI_FAIL_DEBUG_W, wdata, sizeof(wdata));
...
static int lg4946_tci_knock(struct device *dev)
{
	...
	return lg4946_reg_write(dev, TCI_ENABLE_W,
