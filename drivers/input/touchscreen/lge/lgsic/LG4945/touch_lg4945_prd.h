...
#define tc_tsp_test_noise_th		(0x8A65)
#define tc_tsp_test_noise_frame_cnt	(0x8A66)
#define tc_tsp_test_noise_done		(0x8A77)
#define tc_tsp_test_noise_cnt		(0x8A78)
#define tc_tsp_test_noise_p2p		(0x8D72)
