...
#endif
#if defined (CONFIG_LGE_PM_FLOATED_CHARGER_DETECT) \
...
static void mt_battery_modify_charge_parameter_cv3(void)
{
	struct power_supply *charger = power_supply_get_by_name("sm5424");

	if (!charger)
		return;

	/* increase charge current & enable pep */
	batt_cust_data.ac_charger_input_current = CHARGE_CURRENT_1800_00_MA;
	batt_cust_data.ac_charger_current = CHARGE_CURRENT_2000_00_MA;
	batt_cust_data.mtk_pump_express_plus_support = 1;
}
#endif

#ifdef CONFIG_MACH_MT6750_LV5
static void mt_battery_modify_charge_parameter_lv5()
{
...
static void mt_battery_modify_charge_parameter(void)
{
...
#ifdef CONFIG_MACH_MT6750_LV5
	mt_battery_modify_charge_parameter_lv5();
#endif
#ifdef CONFIG_MACH_MT6750_CV3
	mt_battery_modify_charge_parameter_cv3();
#endif
}
#endif
...
void BAT_thread(void)
{
	...
	if (BMT_status.charger_exist == KAL_TRUE) {
#ifdef CONFIG_LGE_PM
		mt_battery_modify_charge_parameter();
#endif
